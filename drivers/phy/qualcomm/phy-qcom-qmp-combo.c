...
/*
 * SM8475 (diwali) tables, ported from the downstream init sequence.
 * Same QSERDES V5 / QPHY V4 PCS register layout as SM8350.
 */
static const struct qmp_phy_init_tbl sm8475_usb3_serdes_tbl[] = {
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_ATB_SEL1, 0x55),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_ATB_SEL2, 0x0e),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SSC_EN_CENTER, 0x02),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SSC_ADJ_PER1, 0x16),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SSC_ADJ_PER2, 0x36),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SSC_PER1, 0x04),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SSC_PER2, 0x2e),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SSC_STEP_SIZE1_MODE0, 0x82),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SSC_STEP_SIZE2_MODE0, 0x04),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SSC_STEP_SIZE3_MODE0, 0x01),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SSC_STEP_SIZE1_MODE1, 0x55),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SSC_STEP_SIZE2_MODE1, 0xd5),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SSC_STEP_SIZE3_MODE1, 0x05),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_POST_DIV, 0x01),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_CLK_ENABLE1, 0x25),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SYSCLK_BUF_ENABLE, 0xb7),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_PLL_EN, 0x1e),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_PLL_IVCO, 0xb7),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_CMN_IETRIM, 0x1e),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_CMN_IPTRIM, 0x55),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_EP_CLOCK_DETECT_CTRL, 0x0e),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_CLK_EP_DIV_MODE1, 0x02),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_CP_CTRL_MODE0, 0x16),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_CP_CTRL_MODE1, 0x36),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_PLL_RCTRL_MODE1, 0x12),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_PLL_CCTRL_MODE0, 0x34),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_PLL_CCTRL_MODE1, 0x04),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_PLL_CNTRL, 0x01),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_BIAS_EN_CTRL_BY_PSM, 0x55),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SYSCLK_EN_SEL, 0xd5),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_CML_SYSCLK_SEL, 0x05),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_LOCK_CMP_CFG, 0x25),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_LOCK_CMP1_MODE0, 0x02),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_DEC_START_MODE0, 0x0e),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_DEC_START_MSB_MODE0, 0x01),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_DIV_FRAC_START1_MODE0, 0x31),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_DIV_FRAC_START2_MODE0, 0x01),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_INTEGLOOP_EN, 0x0c),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_VCO_TUNE1_MODE0, 0x1a),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_VCO_TUNE_INITVAL2, 0x14),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_CMN_STATUS, 0x04),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_CMN_MODE_CONTD, 0xb6),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_VCO_DC_LEVEL_CTRL, 0x4b),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_BIN_VCOCAL_CMP_CODE1_MODE0, 0x37),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_BIN_VCOCAL_CMP_CODE1_MODE1, 0x0c),
};

static const struct qmp_phy_init_tbl sm8475_usb3_tx_tbl[] = {
	QMP_PHY_INIT_CFG(QSERDES_V5_TX_TX_EMP_POST1_LVL, 0x01),
	QMP_PHY_INIT_CFG(QSERDES_V5_TX_TX_DRV_LVL, 0x00),
	QMP_PHY_INIT_CFG(QSERDES_V5_TX_RES_CODE_LANE_TX, 0x00),
	QMP_PHY_INIT_CFG(QSERDES_V5_TX_RES_CODE_LANE_RX, 0x00),
	...
	QMP_PHY_INIT_CFG(QSERDES_V5_TX_LANE_MODE_5, 0x5f),
	QMP_PHY_INIT_CFG(QSERDES_V5_TX_RCV_DETECT_LVL_2, 0x12),
	/* downstream writes different values per lane */
	QMP_PHY_INIT_CFG_LANE(QSERDES_V5_TX_PI_QEC_CTRL, 0x21, 1),
	QMP_PHY_INIT_CFG_LANE(QSERDES_V5_TX_PI_QEC_CTRL, 0x05, 2),
	QMP_PHY_INIT_CFG_LANE(QSERDES_V5_TX_PRE_EMPH, 0x2e, 1),
	QMP_PHY_INIT_CFG_LANE(QSERDES_V5_TX_PRE_EMPH, 0x2d, 2),
};
...
static const struct qmp_phy_init_tbl sm8475_usb3_rx_tbl[] = {
	...
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_UCDR_SB2_THRESH2, 0x08),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_UCDR_SB2_GAIN1, 0x00),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_UCDR_SB2_GAIN2, 0x08),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_AUX_DATA_TCOARSE_TFINE, 0xa0),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_VGA_CAL_CNTRL1, 0x54),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_VGA_CAL_CNTRL2, 0x0f),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_GM_CAL, 0x13),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_RX_EQU_ADAPTOR_CNTRL2, 0x0f),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_RX_EQU_ADAPTOR_CNTRL3, 0x4a),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_RX_EQU_ADAPTOR_CNTRL4, 0x0a),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_RX_IDAC_TSETTLE_LOW, 0x07),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_RX_IDAC_TSETTLE_HIGH, 0x00),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_RX_EQ_OFFSET_ADAPTOR_CNTRL1, 0x47),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_SIGDET_CNTRL, 0x04),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_SIGDET_DEGLITCH_CNTRL, 0x0e),
	...
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_RX_MODE_00_HIGH3, 0xdf),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_RX_MODE_00_HIGH4, 0xfe),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_RX_MODE_01_LOW, 0xdc),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_RX_MODE_01_HIGH, 0x5c),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_RX_MODE_01_HIGH2, 0x9c),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_RX_MODE_01_HIGH3, 0x1d),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_RX_MODE_01_HIGH4, 0x09),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_DFE_EN_TIMER, 0x04),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_DFE_CTLE_POST_CAL_OFFSET, 0x38),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_DCC_CTRL1, 0x0c),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_VTH_CODE, 0x10),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_RX_SIGDET, 0x14),
	/* offset 0x1f8, unnamed in the V5 header */
	QMP_PHY_INIT_CFG(QSERDES_V5_5NM_RX_CDR_FREEZE_UP_DN, 0x08),
};

static const struct qmp_phy_init_tbl sm8475_usb3_pcs_tbl[] = {
	QMP_PHY_INIT_CFG(QPHY_V4_PCS_LOCK_DETECT_CONFIG1, 0xc4),
	QMP_PHY_INIT_CFG(QPHY_V4_PCS_LOCK_DETECT_CONFIG2, 0x89),
	QMP_PHY_INIT_CFG(QPHY_V4_PCS_LOCK_DETECT_CONFIG3, 0x20),
	QMP_PHY_INIT_CFG(QPHY_V4_PCS_LOCK_DETECT_CONFIG6, 0x13),
	QMP_PHY_INIT_CFG(QPHY_V4_PCS_REFGEN_REQ_CONFIG1, 0x21),
	QMP_PHY_INIT_CFG(QPHY_V4_PCS_G12S1_TXMGN_V0, 0x1f),
	QMP_PHY_INIT_CFG(QPHY_V4_PCS_G3S2_TXMGN_MAIN, 0x1f),
	QMP_PHY_INIT_CFG(QPHY_V4_PCS_G12S1_TXDEEMPH_M3P5DB, 0x11),
	QMP_PHY_INIT_CFG(QPHY_V4_PCS_RX_SIGDET_LVL, 0x99),
	QMP_PHY_INIT_CFG(QPHY_V4_PCS_RCVR_DTCT_DLY_P1U2_L, 0xe7),
	QMP_PHY_INIT_CFG(QPHY_V4_PCS_RCVR_DTCT_DLY_P1U2_H, 0x03),
	QMP_PHY_INIT_CFG(QPHY_V4_PCS_CDR_RESET_TIME, 0x0a),
	QMP_PHY_INIT_CFG(QPHY_V4_PCS_ALIGN_DETECT_CONFIG1, 0x88),
...
static const struct qmp_phy_cfg sm8475_usb3dpphy_cfg = {
	...
	.serdes_tbl		= sm8475_usb3_serdes_tbl,
	.serdes_tbl_num		= ARRAY_SIZE(sm8475_usb3_serdes_tbl),
	.tx_tbl			= sm8475_usb3_tx_tbl,
	.tx_tbl_num		= ARRAY_SIZE(sm8475_usb3_tx_tbl),
	.rx_tbl			= sm8475_usb3_rx_tbl,
	.rx_tbl_num		= ARRAY_SIZE(sm8475_usb3_rx_tbl),
	.pcs_tbl		= sm8475_usb3_pcs_tbl,
	.pcs_tbl_num		= ARRAY_SIZE(sm8475_usb3_pcs_tbl),
	.pcs_usb_tbl		= sm8350_usb3_pcs_usb_tbl,
	.pcs_usb_tbl_num	= ARRAY_SIZE(sm8350_usb3_pcs_usb_tbl),
